...
class Control:
    ...
    def __init__(self, plan_dados, path, time):
        ...
        logger.info(30*"-")
        logger.info(colored("Carregando Dados", color="yellow"));
        logger.info(30*"-")
        self.carregaInicio();
        ...
        logger.info(30*"-")
        logger.info(colored("Carregando Problema", color="yellow"));
        logger.info(30*"-")
        ...
        logger.info(30*"-")
        logger.info(colored("Pre-process executado", color="yellow"));
        logger.info(30*"-")
