...
class Sistema:
    ...
    def importaDadosGerais(self):
        ...
        logger.info(30*"-")
        logger.info(colored("IMPORTANDO DADOS GERAIS", color="yellow"))
        logger.info(30*"-")
        ...
        td = timedelta(days = (int(self.inicioSim.day)-2))
    ...
    def importaUsinas(self):
        ...
        while (self.fonte_dados.pegaEscalar("A3", lin_offset=iUsina)is not None):
            ...
            if (self.fonte_dados.pegaEscalar("D3",lin_offset=iUsina) == 0):
                ...
                logger.info(colored(usinaUHE.nomeUsina, color="green"))
                ...
                logger.info(colored(projUHE.nomeUsina, color="green"))
            ...
            # print(iUsina)
            iUsina+=1;
        logger.info(colored(f"Tempo de leitura das UHEs: {datetime.now() - start}", color="yellow"))
        ...
        while (self.fonte_dados.pegaEscalar("D3", lin_offset=iUsina)is not None):
            ...
            if (self.fonte_dados.pegaEscalar("D3",lin_offset=iUsina) == 0):
                ...
                logger.info(colored(usinaTermica.nomeUsina, color="green"))
                ...
                logger.info(colored(projTermica.nomeUsina, color="green"))
            ...
            # print(iUsina)
            iUsina+=1;
        logger.info(colored(f"Tempo de leitura das UTEs: {datetime.now() - start}", color="yellow"))
        ...
        while (self.fonte_dados.pegaEscalar("A3", lin_offset=iUsina)is not None):
            ...
            # print(iUsina)
            iUsina+=1;
        logger.info(colored(f"Tempo de leitura das UTEs Indicativas: {datetime.now() - start}", color="yellow"))
        ...
        while (self.fonte_dados.pegaEscalar("A3", lin_offset=iUsina)is not None):
            ...
            logger.info(colored(projRenovavel.nomeUsina, color="green"))
            ...
            iprojRenov+=1;
        logger.info(colored(f"Tempo de leitura das RENOVAVEIS INDICATIVAS: {datetime.now() - start}", color="yellow"))
        ...
        while (self.fonte_dados.pegaEscalar("A3", lin_offset=iUsina)is not None):
            ...
            logger.info(colored(projReversivel.nomeUsina, color="green"))
            ...
            iprojReversivel+=1;
        logger.info(colored(f"Tempo de leitura das TECNOLOGIAS DE ARMAZENAMENTO: {datetime.now() - start}", color="yellow"))
        ...
        while (self.fonte_dados.pegaEscalar("A3", lin_offset=iUsina)is not None):
            ...
            logger.info(colored(self.fonte_dados.pegaEscalar("B3", lin_offset=iUsina), color="green"))
            ...
            # print(iUsina)
            iUsina+=1;
        logger.info(colored(f"Tempo de leitura das UNSI: {datetime.now() - start}", color="yellow"))
    ...
    def importaDurPatamar(self):
        ...
        logger.info(30*"-")
        logger.info(colored("LEITURA DA DURACAO DE CADA PATAMAR", color="yellow"))
        logger.info(30*"-")
        linhaOffset = 0;
    ...
    def importafatorPat(self):
        ...
        logger.info(30*"-")
        logger.info(colored("LEITURA DOS FATORES DE CONTRIBUIÇÃO PARA UNSI", color="yellow"))
        logger.info(30*"-")
    ...
    def importaRestReversiveis(self):
        ...
        logger.info(30*"-")
        logger.info(colored("LEITURA DOS DADOS DE TECNOLOGIAS DE ARMAZENAMENTO", color="yellow"))
        logger.info(30*"-")        
    ...
    def criaAgrints(self):
        ...
        logger.info(30*"-")
        logger.info(colored("LEITURA DO AGRINT", color="yellow"))
        logger.info(30*"-")        
        num_agrints = 0;
    ...
    def montaListasGerais(self):
        ...
        logger.info(30*"-")
        logger.info(colored("CRIANDO LISTAS COM USINAS", color="yellow"))
        logger.info(30*"-")
...
class Subsistema:
        ...
        def __init__(self, recebe_dados, sis_index, nanos, nmesesTotal, nsis, nCondicoes, numPatamares):
            ...
            logger.info(30*"-")
            logger.info(colored(f"LEITURA DOS DADOS DO SUBSISTEMA {self.sis_index}", color="yellow"))
            logger.info(30*"-")
        ...
        def importaCargaPatamar(self):
            ...
            logger.info(30*"-")
            logger.info(colored(f"IMPORTANDO P.U. PATAMAR", color="blue"))
        ...
        def importaDemanda(self):
            ...
            logger.info(30*"-")
            logger.info(colored(f"IMPORTANDO DEMANDA", color="blue"))
        ...
        def importaInterligacoes(self):
            ...
            logger.info(30*"-")
            logger.info(colored(f"IMPORTANDO PERDAS DE INTERCAMBIO PARA O HORIZONTE", color="blue"))              
            ...
            logger.info(30*"-")
            logger.info(colored(f"IMPORTANDO LIMITES DE INTERCAMBIO (MWm) PARA HORIZONTE ", color="blue"))              
            ...
            logger.info(30*"-")
            logger.info(colored(f"IMPORTANDO LIMITES DE INTERCAMBIO (%) PARA HORIZONTE", color="blue"))              
